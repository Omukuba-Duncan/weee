              ...
              <div className="d-flex flex-column gap-4 mb-5">
                ...
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sm text-muted mb-0">
                      <a href="tel:+254700000000" className="text-decoration-none text-dark">+254 700 000 000</a><br />
                ...
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sm text-muted mb-0">
                      <a href="mailto:info@weeecentre.com" className="text-decoration-none text-dark">info@weeecentre.com</a> (General)<br />
