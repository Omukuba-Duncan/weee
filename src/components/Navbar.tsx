...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const { isChatbotOpen, setChatbotOpen } = useApp();
      ...
      <div className="bg-dark-green text-white py-1 px-3 d-none d-lg-block border-bottom border-secondary border-opacity-25" style={{ fontSize: '0.8125rem' }}>
        <div className="container d-flex justify-content-between align-items-center">
          <div>
            ...
            <span><i className="fa-solid fa-phone me-1 text-accent-green"></i> +254768449499</span>
          </div>
          <div className="d-flex align-items-center">
            <a href="mailto:ogadan254@gmail.com" className="text-white text-decoration-none me-3"><i className="fa-solid fa-envelope me-1 text-accent-green"></i> ogadan254@gmail.com</a>
        ...
        <div className="container">
          ...
          <div className={`collapse navbar-collapse ${mobileMenuOpen ? 'show bg-white p-3 rounded shadow mt-2' : ''}`} id="navbarContent">
            ...
            <div className="d-flex align-items-center gap-2 mt-3 mt-lg-0">
              <button 
                onClick={(e) => { e.preventDefault(); setChatbotOpen(!isChatbotOpen); }}
                className={`btn btn-sm rounded-pill px-3 py-1 font-xs fw-bold d-inline-flex align-items-center shadow-sm ${isChatbotOpen ? 'btn-success text-white' : 'btn-outline-success bg-light text-dark-green'}`}
                title="Open AI Chat Assistant & Kenya Pricing Quotation"
              >
                <i className="fa-solid fa-robot me-1 text-success"></i> AI Chatbot
              </button>
