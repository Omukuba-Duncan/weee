          ...
          <div className="col-12 col-md-6 col-lg-2">
            ...
            <ul className="list-unstyled mb-0 font-sm pe-lg-2">
              ...
              <li className="d-flex mb-3 align-items-center">
                ...
                <a href="tel:+254700000000" className="text-light text-decoration-none">+254 700 000 000</a>
              </li>
              <li className="d-flex mb-3 align-items-center">
                <i className="fa-solid fa-envelope me-2 text-accent-green"></i>
                <a href="mailto:info@weeecentre.com" className="text-light text-decoration-none">info@weeecentre.com</a>
              </li>
