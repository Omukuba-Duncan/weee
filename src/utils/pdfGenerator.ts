  ...
  'epr_2024': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'For corporate onboarding and EPR audit verification, contact our compliance desk at epr@weeecentre.com or call our Nairobi headquarters at +254768449499.'
        ]
      }
    ]
  },
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Home Pickup: For loads exceeding 50kg, request a free residential collection via our website or by calling +254768449499.'
        ]
      },
      {
...
export function downloadResourcePdf(resourceId: string, fallbackTitle: string): void {
  ...
  doc.text('www.weeecentre.com | ogadan254@gmail.com | +254768449499', margin, 27);
